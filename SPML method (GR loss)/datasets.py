...
def get_metadata(dataset_name):
    if dataset_name == 'pascal':
        meta = {
            'num_classes': 20,
            'path_to_dataset': '/home/ali.mekky/Documents/NLP/Project/Cross-Country-Dialectal-Arabic-Identification/SPML/data/pascal',
            'path_to_images': '/home/ali.mekky/Documents/NLP/Project/Cross-Country-Dialectal-Arabic-Identification/SPML/data/pascal/VOCdevkit/VOC2012/JPEGImages'
        }
    elif dataset_name == 'coco':
        meta = {
            'num_classes': 80,
            'path_to_dataset': '../autodl-tmp/coco',
            'path_to_images': '../autodl-tmp/coco'
        }
        ...
        meta = {
            'num_classes': 312,
            'path_to_dataset': '../autodl-tmp/cub',
            'path_to_images': '../autodl-tmp/cub/CUB_200_2011/images'
        }
    else:
